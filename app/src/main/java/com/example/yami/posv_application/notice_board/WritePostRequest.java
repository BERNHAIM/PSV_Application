...
public class WritePostRequest extends StringRequest {
    ...
    final static private String URL = "http://pj9087.dothome.co.kr/WritePost.php";
    private Map<String, String> parameters;

    //생성자
    public WritePostRequest(String postName, String contents, String userID, String anony, Response.Listener<String> listener, boolean check){
