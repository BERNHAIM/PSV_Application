...
public class CommentDeleteRequest extends StringRequest {
    ...
    final static private String URL = "http://pj9087.dothome.co.kr/CommentDelete.php";
    private Map<String, String> parameters;

    public CommentDeleteRequest(String commentNum, Response.Listener<String> listener){
        super(Method.POST, URL, listener, null);
        parameters = new HashMap<>();
        parameters.put("c_num", commentNum+"");
    }
