...
public class CommentRequest extends StringRequest {
    ...
    final static private String URL = "http://pj9087.dothome.co.kr/WriteComment.php";
    private Map<String, String> parameters;

    public CommentRequest(String p_num, String userID, String comment, Response.Listener<String> listener){
        super(Method.POST, URL, listener, null);
        parameters = new HashMap<>();
        parameters.put("p_num", p_num);
